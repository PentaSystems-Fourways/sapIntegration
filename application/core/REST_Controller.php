 ...
 * @link			https://github.com/njuman/codeigniter-restserver
 * @version         3.0.0-pre
 */
...
Class REST_Controller extends CI_Controller {
    ...
    */
    ...
    public function __construct($config = 'rest') {
        ...
        $this->benchmark->mark('rtime_start');
    ...
    protected function _log_access_time() {
        $payload['rtime'] = $this->benchmark->elapsed_time('rtime_start', 'rtime_end');
